...
def insert_random_table_entries():
    ...
    cur.execute("INSERT INTO DeliveryVotes(delivery_order_num, rating) VALUES (1, 'littleCub18', 2)")
    cur.execute("INSERT INTO DeliveryVotes(delivery_order_num, rating) VALUES (2, 'littleCub18', 5)")
