...
def view_menu(): # TODO: implement this function
    ''' Returns a string of name, image (using Tkinter syntax to include images), chef name, description, and price for all menu items on system '''
    # essentially: visually show all rows in the Menu DB 
    # if you can't figure out how to do the image, don't worry about it for now