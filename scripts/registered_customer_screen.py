...
#NOTE: Uncomment line above if trying to insert images of any kind
...
def main():
    root = tk.Tk()
    app = RegisteredCustomerScreen(root)
...
class RegisteredCustomerScreen:
    def __init__(self,master):
        ...
        topDishesButton.place(relx=0.15, rely=0.43, relwidth=0.3, relheight=0.07)

        menuButton = tk.Button(frame, text="View Menu", bg='white', font=('Times New Roman', 14), borderwidth=2, command=self.menu_window)
        menuButton.place(relx=0.15, rely=0.56, relwidth=0.3, relheight=0.07)
        ...
        accountBalanceButton.place(relx=0.15, rely=0.69, relwidth=0.3, relheight=0.07)
        ...
        fileComplaintButton.place(relx=0.6, rely=0.25, relwidth=0.3, relheight=0.07)
        ...
        writeComplimentButton.place(relx=0.6, rely=0.38, relwidth=0.3, relheight=0.07)
        ...
        viewCompButton.place(relx=0.6, rely=0.51, relwidth=0.3, relheight=0.07)
        ...
        checkWarningsButton.place(relx=0.6, rely=0.64, relwidth=0.3, relheight=0.07)
        ...
        DiscussionBoardButton.place(relx=0.6, rely=0.77, relwidth=0.3, relheight=0.07)
...
class MenuWindow:
    def __init__(self, master):
        ...
        menuLabel = tk.Label(menuframe, text="You chose to open to view menu!", font=('Times New Roman', 16), bg="#e6e6e6")
