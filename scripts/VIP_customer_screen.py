...
class VIPCustScreen:
    def __init__(self,master,user):
        ...
        orderButton.place(relx=0.15, rely=0.32, relwidth=0.3, relheight=0.07)
        ...
        top3popDishesButton.place(relx=0.15, rely=0.43, relwidth=0.3, relheight=0.07)
        ...
        top3ratedDishesButton.place(relx=0.15, rely=0.54, relwidth=0.3, relheight=0.07)
        ...
        vipDishesButton.place(relx=0.15, rely=0.65, relwidth=0.3, relheight=0.07)

        menuButton = tk.Button(frame, text="View Menu", bg='white', font=('Times New Roman', 14), borderwidth=2, command=self.menu_window)
        menuButton.place(relx=0.15, rely=0.76, relwidth=0.3, relheight=0.07)
        ...
        viewCompButton.place(relx=0.6, rely=0.35, relwidth=0.3, relheight=0.07)
        ...
        fileComplaintButton.place(relx=0.6, rely=0.5, relwidth=0.3, relheight=0.07)
        ...
        writeComplimentButton.place(relx=0.6, rely=0.65, relwidth=0.3, relheight=0.07)
        ...
        DiscussionBoardButton.place(relx=0.6, rely=0.8, relwidth=0.3, relheight=0.07)
...
# function to open vip dishes window
    def vip_dish_window(self):
        self.app = VipDishWindow(self.root,self.user)
...
class OrderFoodWindow:
    ...
    def home_window(self):
        self.app = VIPCustScreen(self.root,self.user)
